        ...
        <div class="w-full max-w-96 md:max-w-4xl p-4 md:grid md:grid-cols-2 gap-8">
            ...
            <div class="p-8 bg-gray-50 ">
                ...
                <form class="flex flex-col gap-6 ">
                    ...
                    <div class="justify-center md:justify-start  my-4  md:my-0 flex gap-2">
                        ...
                        <a href="/cadastro" class="text-sm text-gray-500 text-purple-600 hover:underline">Clique aqui
                            para
                            cadastrar
                        </a>
                    </div>
